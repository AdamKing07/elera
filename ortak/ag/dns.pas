...
begin
  ...
  begin
    ...
    //SISTEM_MESAJ('DNS.PP: Yerel Port: %d', [_DNS^.FYerelPort]);
    //SISTEM_MESAJ('DNS.PP: Bellek Adresi: %x', [TSayi4(_DNS^.FBellekAdresi)]);
    //SISTEM_MESAJ('DNS.PP: DNS Kimlik: %d', [_DNS^.FKimlik]);
  end;
...
begin
  ...
  //SISTEM_MESAJ('DNS.PP: ADNSKimlik: %d', [ADNSKimlik]);
  //SISTEM_MESAJ_YAZI('DNS.PP: DNS Adres: ', ADNSAdresi);
...
{  SISTEM_MESAJ('-------------------------', []);
  SISTEM_MESAJ('UDP Kaynak Port: %d', [_KaynakPort]);
  SISTEM_MESAJ('UDP Hedef Port: %d', [_HedefPort]);
  SISTEM_MESAJ('UDP Veri Uzunluğu: %d', [_Uzunluk]);
  SISTEM_MESAJ('UDP Sağlama Toplamı: %x', [AUDPPaket^.SaglamaToplam]); }
