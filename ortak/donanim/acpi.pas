...
begin
  ...
  begin
    ...
    SISTEM_MESAJ_YAZI(PChar('Kimlik: '), 8, PChar(RSDPTanimlayici.OEMKimlik), 6);
    SISTEM_MESAJ_S16('Deðiþim: ', RSDPTanimlayici.Degisim, 2);
    SISTEM_MESAJ_S16('RSDT Adres: ', RSDPTanimlayici.RSDTAdres, 8);
    SISTEM_MESAJ_S16('RSDT Sayýsý: ', RSDTSayisi, 8);
  end;
end;
