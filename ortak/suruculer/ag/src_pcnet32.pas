...
begin
  ...
  {$IFDEF PCNET32_BILGI}
  SISTEM_MESAJ_S16('PCNET32 Yol: ', APCI^.Yol, 2);
  SISTEM_MESAJ_S16('PCNET32 Aygýt: ', APCI^.Aygit, 2);
  SISTEM_MESAJ_S16('PCNET32 Ýþlev: ', APCI^.Islev, 2);
  SISTEM_MESAJ_S16('PCNET32 Satýcý Kimlik: ', APCI^.SaticiKimlik, 4);
  SISTEM_MESAJ_S16('PCNET32 Aygýt Kimlik: ', APCI^.AygitKimlik, 4);
  SISTEM_MESAJ_S16('PCNET32 Port: ', AygitPCNET32.TemelAdres, 4);
  SISTEM_MESAJ_S16('PCNET32 IRQ: ', AygitPCNET32.IRQNo, 2);
  {$ENDIF}
  ...
  {$IFDEF PCNET32_BILGI}
  SISTEM_MESAJ_MAC('PCNET32 MAC Adres: ', AygitPCNET32.MACAdres);
  {$ENDIF}
