...
{      SISTEM_MESAJ('Yatay: %d', [Olay.Deger1]);
      ...
      SISTEM_MESAJ_YAZI('Görsel Nesne: ', GorselNesne^.NesneAdi);
      SISTEM_MESAJ('Sol: %d', [GorselNesne^.FKonum.Sol]);
      SISTEM_MESAJ('Üst: %d', [GorselNesne^.FKonum.Ust]);
      SISTEM_MESAJ('Geniþlik: %d', [GorselNesne^.FBoyut.Genislik]);
      SISTEM_MESAJ('Yükseklik: %d', [GorselNesne^.FBoyut.Yukseklik]);
}
